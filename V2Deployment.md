...
**After careful consideration and hearing from a variety of different REP holders, the overwhelming consensus and feedback is that the simplest and best path forward for REP holders and ecosystem participants is to have the current REP token simply maintain the "REP" name and not rename it to REPv1, as initally announced.** 
